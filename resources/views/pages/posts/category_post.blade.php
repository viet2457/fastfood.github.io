                            ...
                            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-4">
                                <div class="post-type post-img">
                                    <a href="{{URL('/bai-viet/'.$post->post_id)}}">
                                        <img src="{{asset('uploads/post/'.$post->post_thumbnail)}}" class="img-responsive" alt="{{$post->post_title}}">
                                    </a>
                                </div>
                            </div>
                ...
                <div class="row">
                    <!-- card -->
                        ...
                        <div class="box-product">
                            ...
                            <div class="body">
                                <h3 class="m-t-0 m-b-5"><a href="blog-details.html">Fast Food Chicken</a></h3>
                                <ul class="meta-post">
                                    <li><a href="javascript:void(0);"><i class="fa fa-account col-blue"></i>Posted By: Hoàng Việt</a></li>
                                    <li><a href="javascript:void(0);"><i class="fa fa-label col-amber"></i>Food</a></li>
                        ...
                        <li class="media mb-4">
                            <div class="row">
                                <div class="col-sm-12 col-md-3">
                                    <img class="d-flex mr-3 img-fluid" width="64" src="{{asset('uploads/post/'.$post->post_thumbnail)}}" alt="{{$post->post_title}}">
                                </div>
